// lib/prompts.js
// Data-only: themes list + prompt pairs (reflection + action) by cadence.
...
// Helper to tag prompts with themes
const T = (...themes) => themes;

// --- DAILY (short, today-focused) ---
const DAILY = [
  {
  ...
  // add the rest of your daily items here …
];

// --- FEW DAYS (3×/week – deeper but still quick) ---
const FEW_DAYS = [
  {
...
// --- WEEKLY (look back across the week) ---
const WEEK = [
  {
  ...
  },
  {
    ...
    action: "Open your next meeting with a check-in and a clear norm about turn-taking.",
    themes: T("Psych Safety","Wellbeing")
  },
  // add the rest …
];
